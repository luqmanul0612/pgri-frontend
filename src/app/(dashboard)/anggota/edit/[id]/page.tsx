...
const EditAnggota: React.FC<pageProps> = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      const getDataMapping: GenericOptions[] = getDataProvinces.data.map(
        (item) => ({
          value: item.code,
          label: item.name,
        }),
  ...
  useEffect(() => {
    (async () => {
      if (formData.provinces) {
        ...
        const getDataMapping: GenericOptions[] = getDataCity.data.map(
          (item) => ({
            value: item.code,
            label: item.name,
          }),
  ...
  useEffect(() => {
    (async () => {
      if (formData.city) {
        ...
        const getDataMapping: GenericOptions[] = getDataDistrict.data.map(
          (item) => ({
            value: item.code,
            label: item.name,
          }),
  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        {/* Data Pribadi */}
        <div id={"dataPribadi"} className={"mb-4 flex flex-col gap-4"}>
          {/*  Judul Data Pribadi */}
          <div className={"flex items-center gap-2.5"}>
            <span
              className={
                "flex h-[34px] w-[34px] items-center justify-center rounded-full bg-[#17A3B8] text-white"
              }
            >
              1
            </span>
          ...
          <div
            className={
              "rounded-2xl border border-[#17A3B8] border-opacity-20 bg-white p-4"
            }
          >
              ...
              <div className={"flex w-1/2 flex-col gap-6"}>
                ...
                <FormField label={"NIK"}>
                  <Input
                    ...
                    className={clsx(
                      "flex items-center gap-2.5 rounded-2xl bg-transparent py-3 pl-4 pr-3 text-[#17a3b8]",
        ...
        {/* Data Pekerjaan */}
        <div id={"dataPekerjaan"} className={"mb-4 flex flex-col gap-4"}>
              ...
              <div className={"flex w-1/2 flex-col gap-6"}>
                ...
                <FormField label={"Nama Instansi Tempat Tugas"}>
                  <Input
                    ...
                    className={clsx(
                      "flex items-center gap-2.5 rounded-2xl py-3 pl-4 pr-3 text-[#17a3b8]",
                      formData.namaIntasiTempatTugas
                        ? "border-[#17a3b8]/20"
                        : "border-gray-300",
                    )}
                ...
                <FormField
                  label={"Kabupaten/Kota/Kota Administrasi Tempat Kerja"}
                >
                  <div className="relative">
                    <select
        ...
        {/* Data Poto & E-KTP */}
        <div id={"dataPotoDanKtp"} className={"mb-4 flex flex-col gap-4"}>
          {/*  Judul Data Pekerjaan */}
          <div className={"flex items-center gap-2.5"}>
            <span
              className={
            ...
            <div className={"flex gap-[26px]"}>
                ...
                <div className={"flex gap-4"}>
                  <div className={"w-4/12"}>
                    <img
                      ...
                      height={"223"}
                      src={
                        previewURL ? previewURL : "/assets/default-image.png"
                      }
                      alt="image"
                    />
                  </div>
                  <div className={"w-8/12"}>
                    <img
                      ...
                      height={"223"}
                      src={
                        previewKTP ? previewKTP : "/assets/default-image.png"
                      }
                      alt="image"
                    />
                  </div>
              ...
              <div className={"flex w-1/2 flex-col gap-6"}>
                <FormField label={"Upload Poto"}>
                  <Input
                    type={"file"}
                    onChange={(e) => handleFileChange(e, "poto")}
                  />
                </FormField>
