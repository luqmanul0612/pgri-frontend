  ...
  return (
    <div className="flex items-center justify-center">
      <div className="relative h-6 w-6">
        ...
        />
        <div
          className={`absolute left-[2px] top-[2px] h-5 w-5 ${
            checked ? "bg-[#db3d35]" : "bg-transparent"
          } ${
            checked
              ? ""
              : "outline outline-[1.50px] outline-offset-[-0.75px] outline-[#17191c]"
          }`}
        >
          {checked && (
            <div className="absolute left-[7.75px] top-[9.17px] h-[5.66px] w-[8.50px] -translate-x-1/2 -translate-y-1/2 transform outline outline-[1.50px] outline-offset-[-0.75px] outline-white">
        ...
        <div className="absolute left-0 top-0 h-6 w-6 border-[1.50px] border-[#17191c] opacity-0" />
      </div>
    </div>
  );
};
