  ...
  return (
    <>
      <div className={"flex flex-col gap-5"}>
        <div className="flex flex-col gap-3 rounded-2xl border border-custom-aqua bg-white p-4">
          <div className="">
            <div className="text-[16px] font-semibold text-primary">
              Total Iuran Anggota PGRI
            </div>
          ...
          <div className={"grid grid-cols-6 gap-4"}>
            <div
              className={
                "flex flex-col gap-3 rounded-2xl border border-custom-aqua bg-white px-6 py-6"
              }
            >
              ...
              <div className="flex flex-col">
                <div className="text-left text-[16px] text-primary">
                  Total Iuran Pusat
                </div>
                <div className="text-left text-xs text-primary">10%</div>
              </div>
            </div>
          ...
          <Card>
            <div className="flex justify-between p-5">
              ...
              <div className="flex gap-4">
                <button className="flex flex-row items-center justify-center gap-1 rounded-lg border border-primary bg-white px-3 py-2 text-sm text-primary">
                  Filter <FilterSVG />
                </button>
                <SearchInput
...
export default FeeAndBillsAdmin;
