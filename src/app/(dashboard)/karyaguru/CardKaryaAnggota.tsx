    ...
    <div className="w-[calc(33.333%-16px)] rounded-2xl border border-custom-aqua bg-white mb-0" >
        <div className='flex justify-between pt-4'>
            <div className='flex px-4'>
                <div className='h-[36px] w-[36px] rounded-md bg-[#d9d9d9]'>
                    {/* <img src='' alt='img'/> */}
                </div>
                <div className='ml-2'>
            ...
            <div className='text-white bg-[#ff5a00] text-xs flex items-center justify-center rounded-bl-full rounded-tl-full px-3'>
                10 Karya
            </div>
        </div>
