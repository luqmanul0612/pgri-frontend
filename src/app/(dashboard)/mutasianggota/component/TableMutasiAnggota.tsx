          ...
          <div className={"flex items-center justify-between p-5"}>
            ...
            <div className={"flex items-center space-x-3"}>
              <button
                ...
                className={
                  "flex flex-row items-center justify-center gap-1 rounded-lg border border-primary px-3 py-2 text-sm text-primary"
                }
              >
              ...
              <div
                className={cn(
                  "flex w-[300px] rounded-lg border border-primary bg-white p-2",
                )}
              >
                <Image
