...
const AddPelatihan: React.FC<IAddPelatihan> = () => {
  ...
  return (
    <>
      <div className={"mb-4"}>
        <h2 className={"font-medium text-primary"}>Tambah Pelatihan</h2>
      </div>

      <div
        className={
          "rounded-2xl border border-primary border-opacity-20 bg-white p-4"
        }
      >
        <form className={"flex flex-col"} onSubmit={handleSubmit(submit)}>
          ...
          <div className={"mb-6 flex gap-6"}>
            ...
            <img
              ...
              src={previewFile ?? "/assets/default-image.png"}
            />
          </div>
          <div className={"mb-4"}>
            <FormField label={"Unggah Banner Pelatihan"}>
              <div
                className={clsx(
                  "relative flex w-full items-center gap-2.5 rounded-2xl border px-4 py-2.5 text-[#17a3b8]",
                  errors.tanggalPelatihan
                    ? "border-[#17a3b8]/20"
                    : "border-gray-300",
                )}
              >
          ...
          <FormField label={"Deskripsi"}>
            <textarea
              className={
                "rounded-2xl border border-primary border-opacity-20 py-3 pl-4"
              }
