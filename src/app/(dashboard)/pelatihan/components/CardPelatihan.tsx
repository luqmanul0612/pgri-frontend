...
const CardPelatihan: React.FC<CardPelatihanProps> = ({}) => {
  return (
    <div>
      <Card className={'hover:bg-white hover:shadow-2xl'}>
        ...
        <CardBody>
          ...
          <div className={"mt-2.5"}>
            ...
            <div>
              <p className={'line-clamp-2 text-[10px]'}>Pelatihan ini dirancang untuk guru dan pendidik yang ingin memahami dan mengimplementasikan teknologi kecerdasan buatan (AI) dalam metode pengajaran mereka. Dengan memanfaatkan AI, guru dapat meningkatkan kualitas pembelajaran, menyesuaikan materi dengan kebutuhan individu siswa, serta meningkatkan efisiensi dalam pengelolaan kelas dan penilaian.</p>
            </div>
          </div>
        </CardBody>
      </Card>
